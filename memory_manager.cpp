...
template<> long long PagedAllocator<uint160_t>::AllocatedMemory = 0;
...
template<> long long PagedAllocator<uint##x, y>::AllocatedMemory = 0; \
...
template<> long long PagedAllocator<ptrs##x, y>::AllocatedMemory = 0; \
